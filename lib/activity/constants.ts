...
> = {
  ...
  "owner.assign": { label: "Ditempatkan", variant: "success" },
  "owner.remove": { label: "Dikeluarkan", variant: "destructive" },
  ...
  "tenant.assign": { label: "Ditempatkan", variant: "success" },
  "tenant.remove": { label: "Dikeluarkan", variant: "destructive" },
  "invoice.create": { label: "Dibuat", variant: "success" },
  "invoice.update": { label: "Diperbarui", variant: "info" },
  "invoice.generate": { label: "Diterbitkan", variant: "warning" },
  "invoice.sync": { label: "Disesuaikan", variant: "info" },
  "water_usage.update": { label: "Diperbarui", variant: "info" },
  "water_usage.import": { label: "Dicatat", variant: "success" },
